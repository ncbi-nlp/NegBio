...
def pipeline(collection, splitter, extractor, parser, ptb2dep, neg_detector, aggregator, verbose=False):
    """
    Args:
...
if __name__ == '__main__':
    ...
    pipeline(collection, splitter, extractor, parser, ptb2dep, neg_detector, aggregator,
             verbose=argv['--verbose'])
